...
using falling_object.cs;


public class TerminalVelocity
{
    public TerminalVelocity(FallingObject falling)
    {
        this.density = calculate_density(falling.get_altitude());
    }

    public double calculate_density(double altitude)
    {
